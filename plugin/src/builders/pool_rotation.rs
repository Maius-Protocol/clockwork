...
use miclockwork_network_program::state::{Config, Pool, Registry, Snapshot, SnapshotFrame, Worker};
use log::info;
...
pub async fn build_pool_rotation_tx<'a>(
    ...
    let ix = Instruction {
        ...
        accounts: miclockwork_network_program::accounts::PoolRotate {
        ...
        data: miclockwork_network_program::instruction::PoolRotate {}.data(),
    };
