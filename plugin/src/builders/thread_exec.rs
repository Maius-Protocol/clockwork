...
use miclockwork_thread_program::state::{VersionedThread, Trigger};
use miclockwork_network_program::state::Worker;
use miclockwork_utils::thread::PAYER_PUBKEY;
use log::info;
...
fn build_kickoff_ix(
    ...
    let mut kickoff_ix = match thread {
        VersionedThread::V1(_) => Instruction {
            program_id: miclockwork_thread_program_v1::ID,
            accounts: miclockwork_thread_program_v1::accounts::ThreadKickoff {
                signatory: signatory_pubkey,
                thread: thread_pubkey,
                worker: worker_pubkey,
            }
            .to_account_metas(Some(false)),
            data: miclockwork_thread_program_v1::instruction::ThreadKickoff {}.data(),
        },
        VersionedThread::V2(_) => Instruction {
            program_id: miclockwork_thread_program::ID,
            accounts: miclockwork_thread_program::accounts::ThreadKickoff {
                signatory: signatory_pubkey,
                thread: thread_pubkey,
                worker: worker_pubkey,
            }
            .to_account_metas(Some(false)),
            data: miclockwork_thread_program::instruction::ThreadKickoff {}.data(),
        },
    };
...
fn build_exec_ix(
    ...
    let mut exec_ix = match thread {
        VersionedThread::V1(_) => Instruction {
            program_id: miclockwork_thread_program_v1::ID,
            accounts: miclockwork_thread_program_v1::accounts::ThreadExec {
                fee: miclockwork_network_program::state::Fee::pubkey(worker_pubkey),
                penalty: miclockwork_network_program::state::Penalty::pubkey(worker_pubkey),
                pool: miclockwork_network_program::state::Pool::pubkey(0),
                signatory: signatory_pubkey,
                thread: thread_pubkey,
                worker: worker_pubkey,
            }
            .to_account_metas(Some(true)),
            data: miclockwork_thread_program_v1::instruction::ThreadExec {}.data(),
        },
        VersionedThread::V2(_) => Instruction {
            program_id: miclockwork_thread_program::ID,
            accounts: miclockwork_thread_program::accounts::ThreadExec {
                fee: miclockwork_network_program::state::Fee::pubkey(worker_pubkey),
                pool: miclockwork_network_program::state::Pool::pubkey(0),
                signatory: signatory_pubkey,
                thread: thread_pubkey,
            ...
            .to_account_metas(Some(true)),
            data: miclockwork_thread_program::instruction::ThreadExec {}.data(),
        },
    };
