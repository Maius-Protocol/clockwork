...
use miclockwork_network_program::state::{Config, Pool, Registry, PoolSettings};
...
pub fn update(client: &Client, id: u64, size: usize) -> Result<(), CliError> {
    ...
    let ix = Instruction {
        ...
        accounts: miclockwork_network_program::accounts::PoolUpdate {
        ...
        data: miclockwork_network_program::instruction::PoolUpdate { settings }.data(),
    };
